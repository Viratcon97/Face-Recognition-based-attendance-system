...
public class User_Fragment_Profile extends Fragment {
            ...
            case R.id.edit_item:
                ...
                update_.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        //Update in Request Report
                        Query query2 = databaseReference.child("Request_Report")
                                .orderByChild("email").equalTo(email);
                        query2.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                                    ...
                                    databaseReference.child("Request_Report").child(Fetch_key).child("email").setValue(updated_email);
                                }
                            }
                        ...
                        //Update in Attendance Change Request
                        Query query3 = databaseReference.child("Attendance_change_request")
                                .orderByChild("email").equalTo(email);
                        query3.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                                    ...
                                    databaseReference.child("Attendance_change_request").child(Fetch_key).child("email").setValue(updated_email);
                                }
                            }
                        ...
                        //Update in Attendance Data
                        Query query4 = databaseReference.child("Attendance_Data")
                                .orderByChild("email").equalTo(email);
                        query4.addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                for (DataSnapshot snapshot : dataSnapshot.getChildren()){
                                    ...
                                    databaseReference.child("Attendance_Data").child(Fetch_key).child("email").setValue(updated_email);
                                    databaseReference.child("Attendance_Data").child(Fetch_key).child("name").setValue(updated_name);
                                }
                            }
