...
public class AdminUserManagementAdapter extends RecyclerView.Adapter<AdminUserManagementAdapter.View_user_management_View_adapter> {

  //  AdminUserManagementAdapter adapter_;
    Context context;
    ...
    public AdminUserManagementAdapter(Context context) {
        this.context = context;
        this.registerAdapterList = new ArrayList<>();
    }
    @Override
    public View_user_management_View_adapter onCreateViewHolder(ViewGroup viewGroup, int i) {

        LayoutInflater inflater = LayoutInflater.from(context);
        View view = inflater.inflate(R.layout.layout_user_management,null);
        return new AdminUserManagementAdapter.View_user_management_View_adapter(view);
    ...
    @Override
    public void onBindViewHolder(final View_user_management_View_adapter holder, final int i) {
                            ...
                            query.addListenerForSingleValueEvent(new ValueEventListener() {
                                ...
                                public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                    for(DataSnapshot snapshot: dataSnapshot.getChildren()) {
                                        String s__totalpresent;
                                        s__totalpresent = snapshot.child("totalpresent").getValue().toString();

                                        Log.i("DATA",snapshot.getValue().toString());
                                        registerAdapter adapter = new registerAdapter(s__fullname,s__mobile,s__email,s__password,s__gender,s__usertype,s__totalpresent);
        ...
        holder.delete_user.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                alert.setMessage("Are You Sure You Want to Delete the User "+adapter.getName()+" ?");
                ...
                //Deleting Record From Attendance_Data
                Query query1 = databaseReference.child("Attendance_change_request").orderByChild("email")
                        .equalTo(adapter.getEmail());
                ...
                //Deleting Record From Attendance Change Request
                Query query2 = databaseReference.child("Attendance_Data").orderByChild("email")
                        .equalTo(adapter.getEmail());
    ...
    public class View_user_management_View_adapter extends RecyclerView.ViewHolder {

            TextView getEmail,getName,getMobile,getSRNo;
            ImageView update_user,delete_user;

        public View_user_management_View_adapter(@NonNull View itemView) {
            super(itemView);
