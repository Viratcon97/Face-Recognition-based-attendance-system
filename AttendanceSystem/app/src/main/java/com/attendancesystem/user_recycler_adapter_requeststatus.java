...
public class user_recycler_adapter_requeststatus extends RecyclerView.Adapter<user_recycler_adapter_requeststatus.View_requestStatus> {


    Context context;
    List<attendancerequestreport> attendancerequestreportslist;

    public user_recycler_adapter_requeststatus(Context context, List<attendancerequestreport> attendancerequestreportslist) {
    ...
    public View_requestStatus onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new user_recycler_adapter_requeststatus.View_requestStatus(view);
    }
